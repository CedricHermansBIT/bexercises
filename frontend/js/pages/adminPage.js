...
class AdminPage {
    ...
    async init() {
        ...
        if (tabFromUrl && ['exercises', 'files', 'users', 'notifications'].includes(tabFromUrl)) {
    ...
    setupEventListeners() {
        ...
        addListener('refresh-notifications-btn', 'click', () => {
            this.loadNotifications();
        });

        addListener('save-notification-btn', 'click', () => {
    ...
    async loadNotifications() {
        try {
            const notifications = await this.apiService.getAllNotifications();
    ...
    renderNotificationsList() {
        ...
        this.notifications.forEach(notification => {
            ...
            const expiresText = notification.expires_at
                ? `Expires: ${this.formatDateTime(notification.expires_at)}`
                : 'No expiration';
            ...
            item.innerHTML = `
                <div class="notification-item-content">
                    ...
                    <small>Created by: ${notification.created_by_name || 'Unknown'} | ${this.formatDateTime(notification.created_at)}</small>

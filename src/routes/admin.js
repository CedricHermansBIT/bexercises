...
router.post('/run-test-case', async (req, res) => {
    try {
        ...
        // Map 'sql' to 'sql' for backwards compatibility
        const needsDatabaseContainer = isDatabaseExercise && (languageId === 'sql' || languageId === 'mongodb');
        ...
        if (needsDatabaseContainer) {
            ...
            try {
                ...
                console.log(`[Admin Test] Starting ${languageId} container with fixtures:`, fixtures);
